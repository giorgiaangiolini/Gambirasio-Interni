...
function Header({ altLangs, settings }) {
  ...
  return (
    <>
      <header className={`fixed hover:bg-white transition-all duration-300 left-0 top-0 z-50 w-full px-[16px] py-1 md:px-4 font-secondary ${router.pathname === "/" ? "bg-transparent" : "bg-white"}`}>

    ...
    <Layout settings={settings} meta={data} altLangs={locales}>
      <div className="flex md:flex-row flex-col min-h-full md:pt-5 pt-6 md:pb-2 pb-4 md:px-4 px-1">
        <div className="md:w-[30%] w-full">
          <div className="sticky flex flex-col gap-2 md:top-[50vh] md:-translate-y-1/2 md:pr-8 text-grey md:text-base text-xs md:mb-0 mb-1">
            <FadeInAnimation>{data.descrizione}</FadeInAnimation>
            <a href="mailto:info@gambirasio.it" target="_blank" className="text-blue underline hover:opacity-60">Richiedi informazioni</a>
          </div>
        </div>
